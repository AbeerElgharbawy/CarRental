					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('updateTestimonial',['id' => $testimonial->id])}}" method="post" enctype="multipart/form-data">
										@csrf
										@method('put')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<img src="{{ asset('assets/images/'. $testimonial->image)}}" alt="{{$testimonial->image}}" style="width: 300px;">
											</div>
										</div>
